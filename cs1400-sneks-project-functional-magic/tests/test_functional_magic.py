...
class TestFunctionalMagic(asttest.ASTTest):
    ...
    def test_required_syntax(self):
        ...
        for call in calls:
            if isinstance(call.func, ast.Name) and call.func.id == "calculate_rating":
                count += 1
        ...
        self.assertIn("""# Do NOT change the following function definition
...
""", self.file,
            "You should not change the calculate_rating function! "
                    "You will need to download the starter code file from "
                    "codegrinder again. Ask your instructor for help if you "
                    "get lost.")

        # Assert main is called correctly
        if """if __name__ == '__main__':
    main()""" not in self.file:
            self.fail("You should not change the calculate_rating function! "
                    "You will need to download the starter code file from "
                    "codegrinder again. Ask your instructor for help if you "
                    "get lost.")
